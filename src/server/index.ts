...
class Server {
  ...
  newZmq(type: keyof typeof SocketType) {
    switch (type) {
      default:
      case "Reply":
...
export class Heartbeat extends Server {
  ...
  constructor(props: any) {
    super(props);
    this.sock = this.newZmq("Reply") as zeromq.Reply;
  }
...
export class Router extends Server {
  ...
  constructor(props: any) {
    super(props);
    this.sock = this.newZmq("Router") as zeromq.Router;
  }
...
export class Publisher extends Server {
  ...
  constructor(props: any) {
    super(props);
    this.sock = this.newZmq("Publisher") as zeromq.Publisher;
  }
